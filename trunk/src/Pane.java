...
Dprintf.dprintf("pane.delta=%d pane.dragDelta=%d dragDelta=%d n=%d min=%d max=%d",pane.delta,pane.dragDelta,dragDelta,n,min,max);
Dprintf.dprintf("(dragDelta-pane.dragDelta)=%d n+(dragDelta-pane.dragDelta)=%d",(dragDelta-pane.dragDelta),n+(dragDelta-pane.dragDelta),min,max);
